...
# Description: Installs colorscheme for gnome-terminal
# Destination: This script will install GConf2 for configurating terminal and set colorscheme "Kasugano"
...
# Create profile
echo 'Create a new profile with name:'
read -r profile_name
id=$(create_new_profile $profile_name)

message 'Installing colorscheme for Gnome Terminal'
[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="daniilshilo"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="daniil-shilo"
[[ -z "$DCONF" ]] && DCONF=dconf
...
gset string palette "#3d3d3d:#6673bf:#3ea290:#b0ead9:#31658c:#596196:#8292b2:#c8cacc:#4d4d4d:#899aff:#52ad91:#98c9bb:#477ab3:#7882bf:#95a7cc:#edeff2"
gset string background_color "#1b1b1b"
